  ...
  var Orbit = function(el, settings) {
    ...
    self.build_markup = function() {
      ...
      if (settings.bullets) {
        ...
        bullets_container = $('<ol style="display:none;">').addClass(settings.bullets_container_class);
    ...
    self.compute_dimensions = function() {
      ...
      if ( typeof bullets_container !== 'undefined' )
      {
          bullets_container.addClass('show-for-small');
      }
    };
